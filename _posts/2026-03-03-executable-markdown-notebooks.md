...
The image includes TeX Live, Pandoc, Python, Pygments, and Mermaid CLI. See the [Docker LaTeX post](/posts/docker-latex-reproducible-builds/) for implementation details.
...
Continue reading for the full implementation, or grab the [complete template on Gumroad](https://derrekito.gumroad.com/) to start immediately.
