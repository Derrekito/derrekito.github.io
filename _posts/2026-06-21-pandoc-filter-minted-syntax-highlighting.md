...
The filter integrates with containerized LaTeX environments as described in [Docker-Based LaTeX Compilation](/posts/docker-latex-reproducible-builds/). The container must include:
