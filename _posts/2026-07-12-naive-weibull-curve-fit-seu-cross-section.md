---
title: "SEU/SEE Statistical Modeling: Naive Weibull Curve Fitting for SEU Cross-Section Data"
date: 2026-07-12
...
This post serves as an educational introduction to Weibull curve fitting. For production analysis requiring reproducible, defensible results, see the companion series: [Rigorous SEU Cross-Section Analysis: A Methodological Manifesto Against Vibe Fitting](/posts/seu-cross-section-manifesto-vibe-fitting/).
...
**Zero-event handling**: Real test data often includes LET values where no upsets were observed. These observations provide upper-limit constraints but cannot be handled by standard MLE (the likelihood involves log(0)). The rigorous series covers the Quinn 3.7/Φ upper limit rule in [Part 4: Zero-Event Treatment](/posts/seu-cross-section-zero-events/).

**Model validation**: The deviance test provides limited discriminatory power with 5 data points. Overdispersion tests, residual analysis, and validation pipelines are covered in [Part 5: Deviance Testing](/posts/seu-cross-section-deviance-test/) and [Part 7: Validation Pipelines](/posts/seu-cross-section-validation-pipeline/).

**Method selection**: The choice between MLE variants (Standard, SmallSample, WithZeros) and bootstrap configurations (Full vs Conservative) should follow automated decision rules based on data characteristics, not analyst judgment. The [Manifesto](/posts/seu-cross-section-manifesto-vibe-fitting/) presents the complete decision tree.
...
Start with the [Manifesto](/posts/seu-cross-section-manifesto-vibe-fitting/) for the complete framework.
...
0. [Rigorous SEU Cross-Section Analysis: A Methodological Manifesto Against Vibe Fitting](/posts/seu-cross-section-manifesto-vibe-fitting/) - Decision tree overview
1. [MLE for Weibull Cross-Sections](/posts/seu-cross-section-mle-weibull/) - When normal approximations hold
2. [Parametric Bootstrap for SEU Data](/posts/seu-cross-section-bootstrap-uncertainty/) - When MLE covariance fails
3. [Choosing Confidence Intervals](/posts/seu-cross-section-confidence-intervals/) - BCA vs Percentile methods
4. [When N=0: Zero-Event Treatment](/posts/seu-cross-section-zero-events/) - Upper limits done right
5. [Deviance Testing for Model Adequacy](/posts/seu-cross-section-deviance-test/) - Goodness-of-fit assessment
6. [Derived Parameter Validation](/posts/seu-cross-section-parameter-validation/) - Physical constraints
7. [Automated Validation Pipelines](/posts/seu-cross-section-validation-pipeline/) - From data to defensible results
