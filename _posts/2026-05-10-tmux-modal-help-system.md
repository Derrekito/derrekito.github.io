...
```mermaid
graph TD
    A["<b>tmux Modal Help System</b>"]

    A --> B["<b>Root Mode</b><br/>(prefix ?)"]
    A --> C["<b>Copy Mode</b><br/>(H)"]
    A --> D["<b>Choose-Tree Mode</b><br/>(h)"]

    B --> B1["Pane Management<br/>creation, navigation, resizing"]
    B --> B2["Window Management<br/>operations and navigation"]
    B --> B3["Session Operations<br/>switch, attach, detach"]
    B --> B4["Mode Entry Points<br/>access to other modes"]

    C --> C1["Vim-style Movement<br/>h/j/k/l, word jumps, line ops"]
    C --> C2["Selection<br/>visual, line, rectangle"]
    C --> C3["Search Operations<br/>forward/backward, incremental"]
    C --> C4["Yank/Copy Operations<br/>copy and exit"]

    D --> D1["Tree Navigation<br/>j/k movement, expand/collapse"]
    D --> D2["Session Operations<br/>kill, rename, select"]
    D --> D3["Window Operations<br/>kill, rename, select"]
    D --> D4["View Options<br/>preview, sort, filter"]

    style A fill:#393552,stroke:#9ccfd8,stroke-width:2px,color:#e0def4
    style B fill:#3e8fb0,stroke:#c4a7e7,stroke-width:2px,color:#e0def4
    style C fill:#3e8fb0,stroke:#c4a7e7,stroke-width:2px,color:#e0def4
    style D fill:#3e8fb0,stroke:#c4a7e7,stroke-width:2px,color:#e0def4
    style B1 fill:#2a273f,stroke:#ea9a97,color:#e0def4
    style B2 fill:#2a273f,stroke:#ea9a97,color:#e0def4
    style B3 fill:#2a273f,stroke:#ea9a97,color:#e0def4
    style B4 fill:#2a273f,stroke:#ea9a97,color:#e0def4
    style C1 fill:#2a273f,stroke:#f6c177,color:#e0def4
    style C2 fill:#2a273f,stroke:#f6c177,color:#e0def4
    style C3 fill:#2a273f,stroke:#f6c177,color:#e0def4
    style C4 fill:#2a273f,stroke:#f6c177,color:#e0def4
    style D1 fill:#2a273f,stroke:#9ccfd8,color:#e0def4
    style D2 fill:#2a273f,stroke:#9ccfd8,color:#e0def4
    style D3 fill:#2a273f,stroke:#9ccfd8,color:#e0def4
    style D4 fill:#2a273f,stroke:#9ccfd8,color:#e0def4
```
