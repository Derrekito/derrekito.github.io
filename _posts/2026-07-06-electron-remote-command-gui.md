...
graph TD
    ...
    subgraph RemoteServer ["Remote Server"]
        ...
        RespStream["Response Streaming"]
    end

    MainProcess -->|IPC contextBridge| RendererProcess
    RendererProcess -->|Socket.IO| RemoteServer
    SocketServer --> CmdExec
    SocketServer --> RespStream
```
