---
title: "Trading Infrastructure (Part 9): Monte Carlo Methods for Trading Risk Analysis: VaR, CVaR, and Beyond"
date: 2026-08-07
...
*Part 9 of the [Real-Time Trading Infrastructure series](/posts/event-driven-trading-nats-jetstream/). Previous: [Part 8: Probabilistic Market Regime Classification](/posts/bayesian-market-regime-detection/). Next: [Part 10: Production Deployment and Operations](/posts/production-trading-system-lessons/).*
...
- **Part 10**: [Production Deployment and Operations](/posts/production-trading-system-lessons/) - Deployment and monitoring
