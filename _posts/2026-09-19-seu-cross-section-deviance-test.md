---
title: "SEU Cross-Section Analysis (Part 5): Does the Weibull Fit? Deviance Testing for Model Adequacy"
date: 2026-09-19
...
| Post | Topic |
|------|-------|
| [Part 0](/posts/seu-cross-section-manifesto-vibe-fitting) | Methodological Manifesto Against Vibe Fitting |
| [Part 1](/posts/naive-weibull-curve-fit-seu-cross-section) | Naive Weibull Curve Fitting |
...
*Next: [Derived Parameter Validation](/posts/seu-cross-section-parameter-validation) - Physical constraints and typical parameter ranges.*
