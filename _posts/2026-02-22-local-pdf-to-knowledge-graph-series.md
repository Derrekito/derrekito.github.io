---
title: "PDF to Knowledge Graph (Part 0): From PDFs to Knowledge Graphs"
...
```mermaid
graph TD
    A["PDF Documents"] -->|MinerU Extraction| B["Markdown Text"]
    B -->|Ollama LLM| C["Ollama LLM"]
    C -->|Instructor Schema| D["Instructor Schema"]
    D -->|Kuzu Graph| E["Kuzu Graph"]
    E -->|Visualization| F["vis.js Visual"]
    E -->|Query Interface| G["LLM Query Interface"]
```
