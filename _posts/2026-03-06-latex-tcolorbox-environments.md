...
graph TD
    A[".pdf_pipeline/"]
    B["latex/"]
    C["tcolorbox-environments.tex<br/>(Environment definitions)"]
    D["template.latex<br/>(Loads environments)"]
    E["docs/"]
    F["TCOLORBOX_USAGE.md"]

    G["notebooks/"]
    H["src/"]
    I["print_helpers.py<br/>(Python wrappers)"]
