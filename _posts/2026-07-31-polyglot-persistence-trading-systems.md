---
title: "Trading Infrastructure (Part 2): Choosing the Right Database for Each Job: MongoDB, Redis, and DuckDB"
date: 2026-07-31
...
*Part 2 of the [Real-Time Trading Infrastructure series](/posts/event-driven-trading-nats-jetstream/). Previous: [Part 1: Market Data Ingestion](/posts/websocket-market-data-pipeline/). Next: [Part 3: Event-Driven Architecture with Message Queues](/posts/event-driven-trading-nats-jetstream/).*
...
graph TD
    ...
    subgraph storage["Storage Layer"]
        MONGO["MongoDB<br/>Tick Storage<br/>- Time-series data<br/>- TTL expiration<br/>- Capped collections"]
        REDIS["Redis<br/>Hot Cache<br/>- Current state<br/>- Position data<br/>- Order book"]
        EVENTBUS["Event Bus<br/>Kafka/RabbitMQ<br/>- Signal distribution<br/>- Order events<br/>- Strategy coordination"]
    end

    subgraph analytics["Analytics"]
        DUCKDB["DuckDB<br/>Analytical Queries<br/>- Backtesting<br/>- Performance reporting<br/>- Feature engineering<br/>- Statistical analysis"]
    end
...
*Series Navigation:*
- [Part 1: Market Data Ingestion](/posts/websocket-market-data-pipeline/) - WebSocket connections and data normalization
- **Part 2: Polyglot Persistence** (current)
- [Part 3: Event-Driven Architecture](/posts/event-driven-trading-nats-jetstream/) - Message queues and system decoupling
