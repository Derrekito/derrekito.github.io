...
```mermaid
flowchart TD
    A["1. Root Privilege Verification"] --> B["2. Package Installation<br/>(distribution-specific)"]
    B --> C["3. Service Enablement<br/>(pcscd)"]
    C --> D["4. Browser Profile Discovery"]
    D --> E["5. DoD Certificate Acquisition"]
    E --> F["6. NSS Database Initialization"]
    F --> G["7. PKCS#11 Module Registration"]
    G --> H["8. Certificate Import and<br/>Trust Configuration"]
    H --> I["9. File Permission Correction"]
    I --> J["10. Verification and Cleanup"]
