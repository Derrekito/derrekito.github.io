---
title: "Trading Infrastructure (Part 7): Building a Composable Technical Indicator Framework"
date: 2026-08-05
...
*Part 7 of the [Real-Time Trading Infrastructure series](/posts/event-driven-trading-nats-jetstream/). Previous: [Part 6: OHLCV Aggregation](/posts/ohlcv-aggregation-etl-pipelines/).*
...
The next post covers Bayesian market regime detection with statistical methods for identifying market states.
...
| 5 | [REST API Caching for Market Data](/posts/rest-api-caching-market-data/) | Published |
| 6 | [OHLCV Aggregation](/posts/ohlcv-aggregation-etl-pipelines/) | Published |
| **7** | **Technical Indicator Framework** | **Current** |
| 9 | [Bayesian Market Regime Detection](/posts/bayesian-market-regime-detection/) | Next |
