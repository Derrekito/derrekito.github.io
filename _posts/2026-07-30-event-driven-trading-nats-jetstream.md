---
title: "Trading Infrastructure (Part 1): Designing an Event-Driven Trading Infrastructure with NATS JetStream"
date: 2026-07-30
...
```mermaid
graph TD
    subgraph JetStream["NATS JetStream Cluster"]
        MARKET_DATA["MARKET_DATA<br/>md.>"]
        ORDERS["ORDERS<br/>orders.>"]
        POSITIONS["POSITIONS<br/>positions.>"]
        RISK["RISK<br/>risk.>"]
    end

    subgraph Services["Services"]
        MDA["Market Data<br/>Adapter"]
        OG["Order<br/>Gateway"]
...
*Next in the series: [Part 2: Polyglot Persistence for Trading Data](/posts/polyglot-persistence-trading-systems/) examines storage strategies for different data types—time-series databases for market data, document stores for order state, and graph databases for entity relationships.*
